...
const StripePayment = ({ item, session }) => {
    ...
    useEffect(() => {
        // axios.post('http://localhost:8080/createPaymentIntent', http://localhost:8080/createPaymentIntent
        axios.post('http://localhost:8080/createPaymentIntent', { price: item?.price })
            .then((res) => {
