...
const Admin_dashboard = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:8080/api/v1/getUserDataCount')
    .then(res => {
    ...
    axios.get('http://localhost:8080/api/v1/petCommunity')
      .then(res => setTotalPost(res.data.length))
      .catch(error => console.log(error))

    axios.get('http://localhost:8080/api/v1/petlistings')
